  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: Container(
         ...
         Card(
          ...
          child: ListTile(
            ...
            title: Text('Sounds'),
            trailing: Icon(
              Icons.toggle_on_outlined, color: Color.fromRGBO(5, 195, 107, 50), size: 35, 
            ),
          ),
        ),
        ...
        Text('ACCOUNT',
         ...
         Card(
          ...
          child: ListTile(
            leading: Icon(
                        Icons.alternate_email_outlined, color: Colors.black,
                      ),
            title: Text('Email'),
            trailing: Icon(Icons.arrow_forward_ios_outlined),
            onTap: () {},
        ...
        Card(
          ...
          child: ListTile(
            leading: Icon(
                    Icons.pin_outlined, color: Colors.black,
                  ),
            title: Text('Password'),
            trailing: Icon(Icons.arrow_forward_ios_outlined),
            onTap: () {},
